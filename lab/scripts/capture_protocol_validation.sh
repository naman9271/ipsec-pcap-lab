...
for p in 1 2 3 4 5; do
 ...
 if [[ $p == 5 ]]; then sudo docker exec ipsec-left ping -6 -c 3 -I fd10::1 fd20::1 >/dev/null; elif [[ $p == 4 ]]; then sudo docker exec ipsec-left ping -c 3 -I 172.30.0.2 172.30.0.3 >/dev/null; else sudo docker exec ipsec-left ping -c 3 -I 10.10.0.1 10.20.0.1 >/dev/null; fi
